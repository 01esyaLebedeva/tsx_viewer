...
import { Calendar, Target, Trophy, Clock, Dumbbell, CheckCircle, Circle, ChevronRight, ChevronLeft, Star, Flame, Users } from 'lucide-react';
...
const WorkoutProgram = () => {
  ...
  const goals = [
    { icon: Target, text: "Подтянуть мышцы", color: "bg-pink-100 text-pink-600" },
    { icon: Flame, text: "Убрать жир", color: "bg-orange-100 text-orange-600" },
    { icon: Star, text: "Улучшить форму", color: "bg-purple-100 text-purple-600" },
    { icon: Trophy, text: "Укрепить колени", color: "bg-green-100 text-green-600" }
  ];
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center space-x-3">
            <div className={`p-2 rounded-lg ${
              ...
              <Dumbbell className={`w-5 h-5 ${isCompleted ? 'text-green-600' : 'text-blue-600'}`} />
            </div>
            <div>
